...
name: verify
description: >
  Valida que la implementación coincida con los documentos de referencia ejecutando tests
  y build. Opera en dos modos: con specs (verificación formal) o sin specs (solo tests + build).
---

# Verify Skill — Context Guard
