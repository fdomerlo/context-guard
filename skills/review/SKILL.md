...
name: review
description: >
  Realiza auditoría estática de código comparando contra documentos de referencia (SPECs, ADRs).
  A diferencia de verify (que ejecuta tests), review analiza el código sin ejecutarlo.
---

# Review Skill — Context Guard
